...
#define DELTA
  ...
  #define DELTA_HEIGHT 286.87 // get this value from auto calibrate
  ...
  #define DELTA_TOWER_ANGLE_TRIM { 0.10, 0.55, -0.65 } // get these values from auto calibrate
...
#define HOMING_FEEDRATE_Z  (100*25)
